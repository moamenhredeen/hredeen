const data = {
  ...
  "links": [
    ...
    {
      "source": "Discovery of Type II Inhibitors of TGFβ-Activated Kinase 1 (TAK1) and Mitogen-Activated Protein Kinase Kinase Kinase Kinase 2 (MAP4K2)",
    ...
    {
      "source": "The clinically approved drugs dasatinib and bosutinib induce anti-inflammatory macrophages by inhibiting the salt-inducible kinases",
    ...
    {
      "source": "Palmitoylation of the Na/Ca exchanger cytoplasmic loop controls its inactivation and internalization during stress signaling",
    ...
    {
      "source": "Crystallographic analysis of Neisseria meningitidis PorB extracellular loops potentially implicated in TLR2 recognition",
    ...
    {
      "source": "3-(2-oxoethylidene)indolin-2-one derivatives activate Nrf2 and inhibit NF-κB: potential candidates for chemoprevention.",
    ...
    {
      "source": "Structure-Guided Design and Optimization of Small Molecules Targeting the Protein–Protein Interaction between the von Hippel–Lindau (VHL) E3 Ubiquitin Ligase and the Hypoxia Inducible Factor (HIF) Alpha Subunit with in Vitro Nanomolar Affinities",
      "target": "074-937-457-594-345",
      "value": 2
    },
    {
    ...
    {
      "source": "Characterization of WZ4003 and HTH-01-015 as selective inhibitors of the LKB1-tumour-suppressor-activated NUAK kinases",
      "target": "002-458-268-309-533",
      "value": 2
    },
    {
      "source": "Synthesis of vitamin D3 analogues with A-ring modifications to directly measure vitamin D levels in biological samples",
    ...
    {
      "source": "The Concise Guide to Pharmacology 2013/14.: The Concise Guide to Pharmacology 2013/14: G Protein-Coupled Receptors",
    ...
    {
      "source": "Investigation of acyclic uridine amide and 5′-amido nucleoside analogues as potential inhibitors of the Plasmodium falciparum dUTPase",
    ...
    {
      "source": "De Novo Design of Protein Kinase Inhibitors by in Silico Identification of Hinge Region-Binding Fragments",
    ...
    {
      "source": "Comprehensive characterization and optimization of anti-LRRK2 (leucine-rich repeat kinase 2) monoclonal antibodies",
    ...
    {
      "source": "Structural determinants for ERK5 (MAPK7) and leucine rich repeat kinase 2 activities of benzo[e]pyrimido-[5,4-b]diazepine-6(11H)-ones",
    ...
    {
      "source": "GSK2578215A; a potent and highly selective 2-arylmethyloxy-5-substitutent-N-arylbenzamide LRRK2 kinase inhibitor.",
    ...
    {
      "source": "Analysis of the role of Nrf2 in the expression of liver proteins in mice using two-dimensional gel-based proteomics",
    ...
    {
      "source": "Acinetobacter baumannii FolD ligand complexes – potent inhibitors of folate metabolism and a re‐evaluation of the structure of LY374571",
    ...
    {
      "source": "Synthesis and structure-activity relationships of a novel series of pyrimidines as potent inhibitors of TBK1/IKKε kinases.",
    ...
    {
      "source": "Reduction in BACE1 decreases body weight, protects against diet-induced obesity and enhances insulin sensitivity in mice",
    ...
    {
      "source": "4-benzimidazolyl-3-phenylbutanoic acids as novel PIF-pocket-targeting allosteric inhibitors of protein kinase PKCζ.",
    ...
    {
      "source": "Design, Synthesis and Biological Evaluation of Novel Inhibitors of Trypanosoma brucei Pteridine Reductase 1",
    ...
    {
      "source": "SCF/β-TrCP promotes glycogen synthase kinase 3-dependent degradation of the Nrf2 transcription factor in a keap1-independent manner",
    ...
    {
      "source": "Polyubiquitin binding to optineurin is required for optimal activation of TANK-binding kinase 1 and production of interferon β.",
    ...
    {
      "source": "N1-Benzyl substituted cambinol analogues as isozyme selective inhibitors of the sirtuin family of protein deacetylases",
